...
- [ ] 1.1 Define Drift tables and migrations for products, stock movements, materialized balances, pending operations, sync state, and conflicts.
- [ ] 1.2 Implement local UUIDv7 generation and durable device identity.
...
- [ ] 2.1 Create PostgreSQL migrations for users, devices, refresh tokens, products, stock movements, product balances, `change_log`, `sync_ops`, and `sync_seq_counter`.

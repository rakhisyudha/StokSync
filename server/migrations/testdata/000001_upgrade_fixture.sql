...
-- Representative rows written against the version-1 schema before 000002
-- and 000003 add constraints and authentication indexes.
BEGIN;
...
INSERT INTO products (
    ...
    version, updated_at, updated_by_device_id, created_at
)
VALUES (
    ...
    'LEGACY-001',
    'Legacy stock item',
    'Written before the auth and constraint upgrades',
    'pcs',
    'food',
    3,
    4,
...
UPDATE products
SET deleted_at = TIMESTAMPTZ '2026-01-02 00:00:00+00'
